...
\paragraph{Close} The gamepad's close function, \emph{tdt4258\_gamepad\_release()} will decrement the number of devices that currently is using the driver and free the IRQ channels if the number of devices using the driver is 0.
