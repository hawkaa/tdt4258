...
\\
\\
		All the tests was run without measuring the LED energy consumption (using the jumper configuration on the gamepad). We used a handheld stopwatch for all the tests. The sample trace was dumped into a raw text file and further processed in a spreadsheet.
		\\
		\\
